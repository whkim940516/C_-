...
int main() {
   ...
   int TicketTable[10] = {0};  // 1차원 배열 초기화 
   // 배열 선언할 때 주의 사항 ! 
   ...
   switch(Special) {
      ...
      TicketTable[0] = choice;  // 이용권 
      TicketTable[1] = ticket;  // 시간대 
      TicketTable[2] = Person;  // 연령대 
      TicketTable[3] = OrderCount; // 주문 개수 
      TicketTable[4] = Total;    // 합산 가격 
      TicketTable[5] = Special;  // 우대사항 
