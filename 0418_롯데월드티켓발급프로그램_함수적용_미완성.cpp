...
#include <time.h>
   ...
   void Choice_Ticket() {  // 이용권 및 권종 선택 
	   do{
	      printf("\n==========================================\n\n");
   ...
   void JuminNumber() {   // 주민등록번호 
	...
	void TicketOrderCount() {  // 티켓 주문 개수 
	   do{
   ...
   void PreferentialTreatment() { // 우대사항 
   do{
      printf("우대사항을 선택하세요.\n1. 없음(나이 우대는 자동처리)\n2. 장애인 우대\n3. 국가유공자 우대\n4. 휴가장병 우대\n5. 임산부 우대\n6. 다둥이 행복카드 우대\n");
      scanf("%d", &Special);
      printf("\n==========================================\n\n");
   ...
   void PreferentialTreatment_Price() {
...
int main() {
	   ...
	   // 따라서 배열은 넉넉하게 만들어주자  
	      ...
	      TicketTable[OrderCount][3] = OrderCount; // 주문 개수 
	      TicketTable[OrderCount][4] = Total;    // 합산 가격 
	      TicketTable[OrderCount][5] = Special;  // 우대사항 
//	      OrderCount++;
