...
int main() {
	...
	// 필요한 변수들 
	int choice, ticket, juminnum_Front, juminnum_Back, OrderCount, Special, BirthYear, BirthDay, BirthMonth, Generation_1900, Generation_2000, age, Price, SpecialPrice, Total;
